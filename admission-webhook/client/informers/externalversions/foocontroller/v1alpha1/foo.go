...
import (
	...
	foocontroller_v1alpha1 "github.com/diptadas/kubernetes-examples/admission-webhook/apis/foocontroller/v1alpha1"
	...
	v1alpha1 "github.com/diptadas/kubernetes-examples/admission-webhook/client/listers/foocontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FoocontrollerV1alpha1().Foos(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FoocontrollerV1alpha1().Foos(namespace).Watch(options)
			},
		},
		&foocontroller_v1alpha1.Foo{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&foocontroller_v1alpha1.Foo{}, f.defaultInformer)
}
