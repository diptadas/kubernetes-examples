...
var foosResource = schema.GroupVersionResource{Group: "foocontroller.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "foocontroller.k8s.io", Version: "v1alpha1", Kind: "Foo"}
